...
def plot_all_lattices_in_one_figure(directory, lattice_size, output_filename=None):
    ...
    files = sorted(
        [f for f in os.listdir(directory) if f.startswith("final_spins") or f.startswith("maxStep_spins")]
    )
...
# Example usage
lattice_size = 16  # Replace with the actual size of your lattice
directory = "../5/"  # Replace with the actual path to your directory
output_filename = "lattices_spin_5.png"  # Optional: save the figure

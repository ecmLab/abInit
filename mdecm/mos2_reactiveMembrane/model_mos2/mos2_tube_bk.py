...
#    slab = mx2('MoS2', kind='2H', a=a, thickness=3.19, size=(1, 2*m, length), vacuum=0)
    slab = mx2('MoS2', kind='1T', a=a, thickness=3.19, size=(1, 20, 3), vacuum=0)
...
write('mos2_aa.data', mos2_tube, format='lammps-data', atom_style='atomic')
write('mos2_aa.xyz', mos2_tube)
write("mos2_aa.pdb", mos2_tube, format="proteindatabank")
